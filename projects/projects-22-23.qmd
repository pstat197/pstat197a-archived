...
![Figure: potential ecological interactions between anchovy and other organisms.](img/23/calcofi-fig.png){width="412"}
...
![](img/23/caves-bee.jpg){width="375"}

![](img/23/caves-oda.png){width="234"}
...
![Figure: counts of visits to points of interest near the Lake Fire (shaded region in center) over time. At left, map of points of interest, with circle size proportional to visit count; at right, total visits across region over time.](img/23/move-animation.gif)
...
![Figure: Stanford synchrotron radiation lightsource facility.](img/23/SLAC-figure.jpg){width="300"}
