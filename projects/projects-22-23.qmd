...
![Figure: Left, example knowledge graph with three entity types and two relations. Right, summary of example relations for possible entity type pairs.](img/Amgen_figure.jpg){width="444"}
...
![Figure: potential ecological interactions between anchovy and other organisms.](img/calcofi-fig.png){width="412"}
...
::: {.column width="25%"}
![](img/CarpeCapstoneLogo.png){width="128"}
:::
:::
...
::: {#fig-caves layout-ncol="2"}
![](img/caves-bee.jpg){width="450"}

![](img/caves-oda.png){width="281"}

Estimation of ommatidial diameters from high-resolution frontal image.
:::
...
::: {.column width="25%"}
![](img/CCBER-emblem.png){width="100"}
:::
:::
...
::: columns
::: {.column width="30%"}
![](img/Evidation-image.jpg){width="200"}
:::
...
![Figure: counts of visits to points of interest near the Lake Fire (shaded region in center) over time. At left, map of points of interest, with circle size proportional to visit count; at right, total visits across region over time.](img/move-animation.gif)
...
::: {.column width="40%"}
![Figure: Stanford synchrotron radiation lightsource facility.](img/SLAC-figure.jpg){width="300"}
:::
:::
