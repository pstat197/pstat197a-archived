...
We have a class [GitHub organization](https://github.com/pstat197) for the data science capstone. Email invitations will be sent to the university email addresses of all enrolled students. Enrolled students should request an email invitation from course staff if they have not received one.

To join the organization students will need to create a GitHub account if they do not already have one. Here is some [advice on choosing a username](https://happygitwithr.com/github-acct.html#username-advice).
