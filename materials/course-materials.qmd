...
*Objectives: build a forecasting model; introduce concepts of spatial and temporal correlation structures; discuss function approximation and curve fitting with regression techniques; fit elementary time series and spatial models; interpolation.*

### Week 7

-   ***Tuesday meeting:*** data introduction; function approximation using basis expansions \[[slides](slides/week7-forecasting.qmd)\]

-   ***Section meeting:*** curve fitting

-   ***Thursday meeting:*** temporal correlation; a forecasting model
